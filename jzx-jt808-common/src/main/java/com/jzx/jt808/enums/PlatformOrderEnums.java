 ...
 */
@AllArgsConstructor
public enum PlatformOrderEnums {
    /** 终端注册 **/
    ...
    /** 设置终端参数 **/
    PLATFORM_SETTING_8103_REQ(0x8103, "设置终端参数", "client -> server");
    ...
    public PlatformOrderEnums setOrder(int order) {
        this.order = order;
        return this;
    }
    ...
    public PlatformOrderEnums setOrderDesc(String orderDesc) {
    ...
    public PlatformOrderEnums setTarget(String target) {
        this.target = target;
        return this;
    }
}